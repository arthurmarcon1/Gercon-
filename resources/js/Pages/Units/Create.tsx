...
export default function Create({ condominium, blocks, unitTypes }: Props) {
    const form = useForm({
        number: '',
        type: '',
        floor: '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        form.post(route('condominiums.units.store', condominium.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-xl font-semibold leading-tight text-gray-800">Nova unidade</h2>
                </div>
            }
        >
                ...
                <div className="mx-auto max-w-lg sm:px-6 lg:px-8">
                    <div className="bg-white p-8 shadow-sm sm:rounded-lg">
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <PrimaryButton disabled={form.processing}>Criar unidade</PrimaryButton>
                        </form>
                    </div>
                </div>
            </div>
